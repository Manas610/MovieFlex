...
import  Logo  from "../assets/M-final.png"
...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white rounded-b-lg border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
